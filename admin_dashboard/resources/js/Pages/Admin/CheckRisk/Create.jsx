...
export default function Create() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    post('/admin/check-risk');
  };

  return (
    <AdminLayout title="Tambah Pertanyaan Check Risk">
      <Head title="Tambah Pertanyaan Check Risk - UtiCare" />
      ...
      <div className="max-w-3xl mx-auto space-y-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-xl font-bold text-slate-800">Tambah Pertanyaan Check Risk</h2>
            <p className="text-xs text-slate-400">Tentukan pertanyaan dan bobot skor pada tiap opsi</p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-2xl border border-slate-200 p-6 shadow-sm space-y-5">
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Contoh: Seberapa sering kamu minum air putih kurang dari 4 gelas sehari?"
