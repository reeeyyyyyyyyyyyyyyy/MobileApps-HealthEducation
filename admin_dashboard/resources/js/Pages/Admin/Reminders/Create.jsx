...
export default function Create() {
  ...
  return (
    <AdminLayout title="Tambah Template Pengingat">
      <Head title="Tambah Template Pengingat - UtiCare" />
      ...
      <div className="max-w-2xl mx-auto space-y-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-xl font-bold text-slate-800">Tambah Template Pengingat</h2>
            <p className="text-xs text-slate-400">Pengingat kebiasaan harian untuk responden</p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-2xl border border-slate-200 p-6 shadow-sm space-y-4">
          <div>
            ...
            <input
              ...
              placeholder="Contoh: Waktunya Minum Air Putih"
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Minum 1-2 gelas air sekarang untuk menjaga kebersihan saluran kemih."
              className="w-full px-3.5 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-violet-500 focus:bg-white"
            />
          </div>
